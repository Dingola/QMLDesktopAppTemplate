...
namespace QmlApp
{
	 ...
	 *
	 * This class implements the Meyers Singleton Pattern using the Curiously Recurring Template Pattern (CRTP).
	 * Note: Derived classes need to declare 'friend class Singleton<T>'.
	 *       Derived classes must also have their constructor set to private to prevent instantiation.
	 */
	template<typename T>
	...
	public:
		 ...
		 *
		 * This function returns the singleton instance of the class, creating it if it does not already exist.
		 * The instance is created in a thread-safe manner.
		 *
