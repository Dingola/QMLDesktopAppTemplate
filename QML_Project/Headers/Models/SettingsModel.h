...
class SettingsModel: public QAbstractItemModel
{
    ...
    private:
        ...
        SettingsNode* create_node(const QString& group, const QString& key, const QVariant& value,
                                  SettingsNode* parent = nullptr);
        SettingsNode* create_or_update_key_node(const QString& key, const QVariant& value,
