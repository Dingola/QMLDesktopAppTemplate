...
namespace QmlApp
{
	 ...
	 *
	 * This constructor initializes a SettingsNode object with the provided group, key, value, and parent node.
	 *
	 ...
	 */
	SettingsNode::SettingsNode(const QString& group, const QString& key, const QVariant& value, SettingsNode* parent)
	 ...
	 * @return The child SettingsNode at the specified row, or nullptr if no child node exists at that index.
	 */
